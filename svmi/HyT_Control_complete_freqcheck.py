...
'''
    ...
    25.05.2018:
        check in pulsesequence if 
        
            pulse delay start/stop < 1/freq 
...
class WorkThread(QThread):
    ...
    def tof_scan(self,units1, chno1, time1, units2, chno2, time2, freqs, pulsenature, checkboxvals, posnegvals, t2jumpfile,
        ...
        for timing in times:
            output,msg = ps.pulses(units1, chno1, time1, units2, chno2, time2, freqs, pulsenature, checkboxvals, posnegvals,scanchannel,relchannel,timing,t2jumpfile)
            plotseq.plotsequence(output,checkboxvals)  
        return
